...
{
var _sName=htmlDecode(_oAddrData.name).toLowerCase(),_nIndex;
...
if((_sTmpValue=_oAddrData.name.replace(_oRegExp,_sReplace))!=_oAddrData.name)
{
...
{
_sItemValue='<img unselectable="on" class="lm_groupUnfold" src="'+getPath('image')+'spacer.gif" title="\u7FA4\u7EC4"/>'+_oAddrData.name.replace(_oRegExp,_sReplace);
}
