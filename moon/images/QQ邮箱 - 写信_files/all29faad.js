...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor29b6d5.js"]);
...
QMAjax.send(t,{method:"POST",content:"fun=followshare&followuin="+n+"&sid="+getSid(),onload:function(e,v){
if(e)
{
...
var s=c&&encryptStr((''+getTop().g_uin).substr(-3)+c);
s||(s=c);
...
f.style.display="";
f.value="";
b.innerHTML="(\u8BF7\u8F93\u5165\u4F60\u7684Gmail\u5E10\u53F7\u7ECF\u5E38\u767B\u5F55\u7684\u4F4D\u7F6E\u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)";
f.focus();
}
...
v.ossLog('delay','all','kw=google_oauth_suc&value=1');
D&&D(K);
}
...
K.errType&&v.LogKV("getinvestigate|googleoauth|fail|"+K.errType);
...
{
y=[d.value,"challengetype%3DVerifySmsChallenge","VerifySmsChallengeAnswer%3D"+x.value.replace(/^G-?/i,"")].join("%26");
...
var a={'comm2010.css':'$css_path$comm201029d903.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
