...
this._initBillUnread();
},_todayRightTabs:function(){
var e=this,g=e._moWin,f={},c,d=GelTags("div",e.S("rightPanelTitle_normal"));
E(d,function(h){
var i=attr(h,"qmTab");
if(i)
{
f[i]={obj:h,container:e.S(attr(h,"container"))};
}
});
e._moQmTab=c=new qmTab({win:g,tab:f,style:{normal:"tab_list bd pointer",over:"tab_list bd pointer",select:"tab_list bd actived"},onchange:function(i,h){
var k=f[i].obj,m=attr(k,"src_iframe"),l=attr(k,"id_iframe"),j=e.S(l);
if(k&&m&&!j)
{
createIframe(g,m,{id:l,obj:f[i].container,where:"beforeEnd",className:attr(k,"class_iframe")||"",style:attr(k,"style_iframe")||"",attrs:attr(k,"attrs_iframe")||""});
}
}});
if(f.birth)
{
...
e.changeInfoTab=g.changeInfoTab=function(h){
c.change(h);
};
},_todayBar:function(){
var c=this,d=c._moWin;
