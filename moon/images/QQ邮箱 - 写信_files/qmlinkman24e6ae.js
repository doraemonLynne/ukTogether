...
var j=this,k=getTop(),c=k.document.location.href.indexOf('from_wm_newwin')>-1,b=!c&&k.document.location.href.indexOf('t=newwin_frame')>-1,g=j._moConfig.oContainer,f=k.calcPos(g,'json').top,h=k.finds('.lm_panel',g)&&k.finds('.lm_panel',g)[0],d=k.calcPos(h,'json').top;
